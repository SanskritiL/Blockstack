...
export default function Body(){
    return(
        <div class="center">
            <h4 style={{"fontWeight":"bold", "color": "white", "textAlign":"center", "margin": "3rem", "border":"2px solid black", "padding":"0.8rem 0rem","backgroundColor":"rgb(77, 76, 76)","borderRadius":"25px"}}>Deep Pocket</h4>
        <div class="card">
